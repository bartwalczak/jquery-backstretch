...
Boolean. If true, then the picture width will always be equal or smaller than the width of the browser frame. Default: true.

h3. fitHeight

Boolean. If true, then the picture height will always be equal or smaller than the height of the browser frame. Default: false.
